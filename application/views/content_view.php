 ...
 -->
            ...
            <div class="six columns">
                ...
                <div class="background-color blog-post-title">
                    ...
                    <a href="blog.html" class="blog-post-link"><?php echo $contentDetatil->title; ?></a>

                    <div class="team-member-icons connection-w deactive"></div>

                    <div class="blog-post-date"><?php echo $contentDetatil->dateTime; ?></div>

                </div>

                <a href="blog.html" title="<?php echo $contentDetatil->title; ?>"><img src="<?php echo $contentDetatil->imgCover; ?>" alt="blog post img" class="blog-post-img"/></a>

                <b><?php echo $contentDetatil->subTitle; ?></b><br><br>

                <p class="text"><?php echo $contentDetatil->isiContent; ?></p>
                ...
                <div class="blog-post-comments">
                    ...
                    <div class="comments">
                         ...
                         <?php foreach($comment as $comment): ?>
                            <div class="comment">
                                ...
                                <script type="text/javascript">console.log('sub',<?php echo json_encode($commentReplay);?>);</script>

                               <!--  <div class="comment sub-comment">

                                    <img src="<?php echo base_url('assets/green/css/img/content/user2.png');?>" class="comment-poster-pic" alt="comment poster">
                                    <div class="name-and-message">
                                        <div class="comment-poster">Jermain Duff</div>
                                        <div class="comment-message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in mi ut erat temp mattis. Nulla sit amet libero id quam fringilla consequat.</div>
                                    </div>
                        ...
                        <!-- <div class="comment">
                            ...
                            <img src="photos/comment-poster-1.png" class="comment-poster-pic" alt="comment poster">
                            <div class="name-and-message">
                                <div class="comment-poster">Charlie Sheen</div>
                                <div class="comment-message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in mi ut erat temp mattis. Nulla sit amet libero id quam fringilla consequat.</div>
                            </div>
                        ...
                        <div class="comment sub-comment">
                            ...
                            <img src="photos/comment-poster-2.png" class="comment-poster-pic" alt="comment poster">
                            <div class="name-and-message">
                                <div class="comment-poster">Jermain Duff</div>
                                <div class="comment-message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in mi ut erat temp mattis. Nulla sit amet libero id quam fringilla consequat.</div>
                            </div>
                        ...
                        <div class="comment">
                            ...
                            <img src="photos/comment-poster-3.png" class="comment-poster-pic" alt="comment poster">
                            <div class="name-and-message">
                                <div class="comment-poster">Jessica Moriati</div>
                                <div class="comment-message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in mi ut erat temp mattis. Nulla sit amet libero id quam fringilla consequat.</div>
                            </div>
                        ...
                        <div class="comment sub-comment">
                            ...
                            <img src="photos/comment-poster-4.png" class="comment-poster-pic" alt="comment poster">
                            <div class="name-and-message">
                                <div class="comment-poster">Michael Gorina</div>
                                <div class="comment-message">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam in mi ut erat temp mattis. Nulla sit amet libero id quam fringilla consequat.</div>
                            </div>
                    ...
                    <input type="hidden" name="contentPost_id" value="<?php echo $contentDetatil->id;?>" />
            ...
            <div class="three columns">
                ...
                <ul class="blog-categories">
                    <?php foreach($categories as $categories) : ?>
                        <li><div class="blog-cat-anim background-color"></div><a href="<?php echo site_url('FrontView/videos'); ?>" title="<?php echo $categories->title; ?>"><?php echo $categories->title; ?></a></li>
                    <?php endforeach; ?>
                ...
                <div class="blog-posts-tab">
                    ...
                    <div class="popular-blogs">
                        ...
                        <?php foreach($popularPost as $popularPost): ?>
                            <?php if ($popularPost->id == $contentDetatil->id) {
                                $url = '#';
                            } else{
 ...
 -->
                    ...
                    <div class="recent-blogs">
                        <?php foreach($recentPost as $recentPost): ?>
                            <?php if ($recentPost->id == $contentDetatil->id) {
                                $url = '#';
                            } else{
